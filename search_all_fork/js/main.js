...
if (form !== null) {
    ...
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Tragkraft:', form.querySelector('[name="Tragkraft Von"]').value);
    });
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Tragkraft:', form.querySelector('[name="Tragkraft Bis"]').value);
    });
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Hubhöhe ab:', form.querySelector('[name="Hubhöhe ab"]').value);
    });

    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected BetreibStunden', form.querySelector('[name="BetreibStunden"]').value);
    });
