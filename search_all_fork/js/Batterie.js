...
if (form !== null) {
    ...
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Art der Batterie:', form.querySelector('[name="Art der Batterie"]').value);
    });
    form.addEventListener('submit', (e) => {
        e.preventDefault();
    ...
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Nennspannung:', form.querySelector('[name="Nennspannung"]').value);
    });
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Batteriekapazität:', form.querySelector('[name="Batteriekapazität"]').value);
    });
    ...
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Baujahr:', form.querySelector('[name="Baujahr"]').value);
    });
