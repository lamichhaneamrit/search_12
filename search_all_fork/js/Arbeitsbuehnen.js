document.addEventListener("DOMContentLoaded", function() {
    var demo1 = new FlSelect({
        selector: "#selectbox",
        placeholder: "Bauart",
        searchbox: false,
        offset: false,
    });
    var demo2 = new FlSelect({
        selector: "#selectbox2",
        searchbox: true,
    ...
    var demo3 = new FlSelect({
        selector: "#selectbox3",
        placeholder: "Hubhühe ab",
        searchbox: true,
        offset: true,
    });
    var demo4 = new FlSelect({
        selector: "#selectbox4",
        placeholder: "Betriebsstunden",
        searchbox: true,
        offset: true,
    });
    var demo5 = new FlSelect({
        selector: "#selectbox5",
        placeholder: "Baujahr",
        searchbox: true,
        offset: true,
    });
    var demo6 = new FlSelect({
        selector: "#selectbox6",
        placeholder: "Tragkraft (von-bis)",
        searchbox: true,
...
if (form !== null) {
    ...
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Bauart:', form.querySelector('[name="Bauart"]').value);
    });
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Fabrikat:', form.querySelector('[name="Fabrikat"]').value);
    });
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Arbeitshöhe von:', form.querySelector('[name="Arbeitshöhe von"]').value);
    });
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Arbeitshöhe bis:', form.querySelector('[name="Arbeitshöhe bis"]').value);
    });
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected korblast ab:', form.querySelector('[name="korblast ab"]').value);
    });

    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Korblast bis:', form.querySelector('[name="Korblast bis"]').value);
    });
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected  Preis Von:', form.querySelector('[name="Preis Von"]').value);
    });
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Preis bis:', form.querySelector('[name="Preis bis"]').value);
    });

    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Land:', form.querySelector('[name="Land"]').value);
    });
