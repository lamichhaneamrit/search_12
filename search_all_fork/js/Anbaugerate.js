...
if (form !== null) {
    ...
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected Eigengewicht bis:', form.querySelector('[name="Eigengewicht bis"]').value);
    });

    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected ISO-Klasse :', form.querySelector('[name="ISO-Klasse"]').value);
    });
