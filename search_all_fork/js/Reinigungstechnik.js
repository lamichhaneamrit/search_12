...
if (form !== null) {
    ...
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected kehrbreite von:', form.querySelector('[name="kehrbreite von"]').value);
    });
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Selected kehrbreite bis:', form.querySelector('[name="kehrbreite bis"]').value);
    });
